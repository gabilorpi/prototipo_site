    ...
    <main class="container" id="main-container">
        ...
        <div class="container">
            <table class="table table-hover">
                ...
                <tbody>
                    <jstl:forEach items="${listaAgencia}" var="agencia">
                        <tr>
                            <td>${agencia.idAgencia}</td>
                            <td>${agencia.nomeAgencia}</td>
                            <td>${agencia.cep}</td>
                            <td>${agencia.rua}</td>
                            <td>${agencia.bairro}</td>
                            <td>${agencia.telefone}</td>
                            <td>
                                <div class="d-flex">
                                    <a href="agencia-edit?id=${agencia.idAgencia}" class="btn btn-warning">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="agencia-delete?id=${agencia.idAgencia}" class="btn btn-danger" onclick="return confirm('Deseja excluir a agência ${agencia.nomeAgencia}?')">
